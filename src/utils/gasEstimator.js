...
async function selectGasProfile(chunkCount) {
    ...
    try {
        ...
        console.log(`L1 Data Fee: ${estimatedGasCosts.l1.eth} ETH ($${estimatedGasCosts.l1.usd})`)
        console.log(`1. Instant: ${estimatedGasCosts.fast.eth} ETH ($${estimatedGasCosts.fast.usd}) (includes L1 fee)`)
        console.log(`2. One chunk per minute: ${estimatedGasCosts.onePerMinute.eth} ETH ($${estimatedGasCosts.onePerMinute.usd}) (includes L1 fee)`)
